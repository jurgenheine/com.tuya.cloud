...
exports.decryptStringSync = void 0;
const make_string_decrypter_sync_1 = require("./make-string-decrypter-sync");
/**
 * A sync decrypt function that can be used to decrypt UTF-8 strings,
 ...
 */
exports.decryptStringSync = make_string_decrypter_sync_1.makeStringDecrypterSync({ algorithm: 'aes-256-gcm' });
