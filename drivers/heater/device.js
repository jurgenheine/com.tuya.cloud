...
class TuyaHeaterDevice extends TuyaBaseDevice {
    onInit() {
        ...
        this.log(`Tuya Heater ${this.getName()} has been initialized`);
    }
    ...
    updateCapabilities(statusArr) {
                this.log("Update heater capabilities from Tuya: " + JSON.stringify(statusArr));
    ...
    normalAsync(name, hbValue) {
        this.log("Set heater Capability " + name + " with " + hbValue);
...
module.exports = TuyaHeaterDevice;
